...
import maleAvatar from 'figma:asset/1d71ee5c89886b1d5707c159fde5d711f1da9a87.png';
import femaleAvatar from 'figma:asset/92f9d230d0cf8dd52b8ffef21796c79509faee4a.png';
import { 
  Upload, 
  Sparkles, 
  Users, 
  ...
  return (
    <div className="min-h-screen bg-[#FCFCFC]">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#D4AF37]/8 via-transparent to-[#D4AF37]/4 pointer-events-none"></div>
        <div className="absolute top-1/4 right-0 w-96 h-96 bg-gradient-to-bl from-[#D4AF37]/10 to-transparent rounded-full blur-3xl pointer-events-none animate-pulse"></div>
        <div className="absolute bottom-1/4 left-0 w-64 h-64 bg-gradient-to-tr from-[#D4AF37]/8 to-transparent rounded-full blur-2xl pointer-events-none animate-pulse" style={{animationDelay: '1s'}}></div>
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-3xl mx-auto mb-12">
            {avatars.map((avatar, index) => (
              <Card key={avatar.id} className="bg-white/90 backdrop-blur-sm border border-gray-100/50 rounded-2xl shadow-sm hover:shadow-lg hover:shadow-[#D4AF37]/10 transition-all duration-300 group cursor-pointer hover:border-[#D4AF37]/20 gold-shimmer">
                <CardContent className="p-8 text-center">
                  {/* Avatar Image Container */}
                  <div className="w-32 h-32 mx-auto mb-6 rounded-full overflow-hidden shadow-lg group-hover:scale-105 transition-transform duration-300 ring-2 ring-[#D4AF37]/20 group-hover:ring-[#D4AF37]/40">
                    <img 
                      src={avatar.id === "rohan" ? maleAvatar : femaleAvatar} 
                      alt={avatar.name}
          ...
          <Button 
            ...
            className="bg-[#77DDE7] hover:bg-gradient-to-r hover:from-[#77DDE7] hover:to-[#77DDE7]/90 text-[#36454F] px-16 py-4 rounded-xl shadow-md hover:shadow-xl hover:shadow-[#D4AF37]/20 transition-all duration-300 text-lg relative overflow-hidden"
            style={{ backgroundColor: '#77DDE7', color: '#36454F' }}
          >
            <span className="relative z-10">Start Chatting Now</span>
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#D4AF37]/15 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-500"></div>
          </Button>
        </div>
      </section>
