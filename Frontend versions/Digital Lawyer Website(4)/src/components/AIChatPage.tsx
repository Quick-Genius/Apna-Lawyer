...
export default function AIChatPage({ selectedAvatar = "rohan" }: AIChatPageProps) {
  const [message, setMessage] = useState("");
  const [isListening, setIsListening] = useState(false);

  const avatarInfo = {
    rohan: { name: "Rohan", title: "Legal Expert" },
    priya: { name: "Priya", title: "Legal Advisor" }
  };

  const currentAvatar = avatarInfo[selectedAvatar as keyof typeof avatarInfo] || avatarInfo.rohan;
      ...
      <div className="flex flex-1">
        ...
        <div className="text-center mb-8 relative z-10">
          <div className="w-24 h-24 mx-auto mb-4 rounded-full overflow-hidden shadow-lg ring-2 ring-[#D4AF37]/20">
            <img 
              src={selectedAvatar === 'priya' ? femaleAvatar : maleAvatar} 
